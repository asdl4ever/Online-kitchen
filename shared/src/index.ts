...
export type AreaKind = "spawn" | "forest" | "lumberYard" | "restaurant" | "phoneStore";
...
export function clampToWorld(pos: Vec2): Vec2 {
...
export function areaAt(pos: Vec2): Area | undefined {
  return AREAS.find((a) =>
    pos.x >= a.bounds.x &&
